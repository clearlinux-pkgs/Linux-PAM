...
Source0  : https://github.com/linux-pam/linux-pam/releases/download/v1.6.0/Linux-PAM-1.6.0.tar.xz
Source1  : https://github.com/linux-pam/linux-pam/releases/download/v1.6.0/Linux-PAM-1.6.0.tar.xz.asc
...
%prep
%setup -q -n Linux-PAM-1.6.0
cd %{_builddir}/Linux-PAM-1.6.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a Linux-PAM-1.6.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709074489
